...
package org.jboss.pnc.buildagent.util;
 ...
 */
public class OutputStreamStringWritter extends java.io.OutputStream {
    ...
    private OutputStreamStringWritter() {
        // illegal
    }

    public OutputStreamStringWritter(Consumer<String> logConsumer) throws IllegalArgumentException {
    ...
    public void flush() {
        ...
        logConsumer.accept(new String(theBytes));
